...
const MOCK_REVIEWS = [
  {
    ...
    date: '2 weeks ago',
    comment:
      'Incredible course structure. The boss battle challenges are genuinely fun and actually teach you the concepts. Best blockchain course I\'ve taken.',
  },
  {
    name: 'Lucas Almeida',
    avatar: 'LA',
    ...
    date: '1 month ago',
    comment:
      'Coming from zero Solana knowledge, this course made everything click. The interactive code editor is a game-changer — you learn by doing, not just reading.',
  },
  {
    name: 'Maria Santos',
    avatar: 'MS',
    ...
    date: '3 weeks ago',
    comment:
      'Great content and pacing. The gamification keeps you motivated. Would love to see more advanced DeFi content in the future.',
  },
  {
    name: 'Pedro Costa',
    avatar: 'PC',
    ...
    date: '1 week ago',
    comment:
      'The on-chain credential system is brilliant. Being able to prove your skills with a verifiable NFT is exactly what the industry needs.',
  },
];
                  ...
                  <div className="flex items-center gap-2 mb-3">
                    {Array.from({ length: 5 }).map((_, i) => (
                      <Star
                        ...
                        className={`h-4 w-4 ${
                          i < review.rating
                            ? 'text-quest-gold fill-quest-gold'

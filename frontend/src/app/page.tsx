...
const TESTIMONIALS = [
  {
    ...
    avatar: 'R',
    quote: 'Solana Quest turned learning Rust and Anchor from intimidating to addictive. The boss battles are genius — I actually look forward to coding challenges now.',
    xp: 8500,
    level: 9,
  },
  {
    ...
    avatar: 'C',
    quote: 'Finally a learning platform built for crypto natives. The on-chain credentials are a game changer for my portfolio, and the streak system keeps me consistent.',
    xp: 6200,
    level: 7,
  },
  {
    ...
    role: 'Web3 Intern',
    avatar: 'D',
    quote: 'I went from zero blockchain knowledge to deploying my first Solana program in 3 weeks. The interactive code editor makes it so much easier to learn by doing.',
    xp: 3100,
    level: 5,
  },
];
...
const PARTNERS = [
  ...
  { name: 'Metaplex', color: '#E42575' },
  { name: 'Superteam', color: '#14F195' },
  { name: 'Anchor', color: '#00D1FF' },
...
export default function LandingPage() {
  ...
  return (
    <div className="relative">
      ...
      <section className="py-20 border-t border-border/40">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-muted-foreground max-w-2xl mx-auto">
              Hear from developers who leveled up their Solana skills with Solana Quest.
            </p>
          </motion.div>
              ...
              >
                <Card className="h-full border-border/50">
                  <CardContent className="p-6">
                    ...
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#9945FF] to-[#14F195] flex items-center justify-center text-white font-bold text-sm">
                        {testimonial.avatar}
                      </div>
                      ...
                      <div className="flex items-center gap-1 text-xs">
                        <Zap className="h-3 w-3 text-quest-gold" />
                        <span className="text-quest-gold font-medium">{testimonial.xp.toLocaleString()}</span>
                      </div>
                    </div>
                  </CardContent>
                </Card>
      ...
      <section className="py-12 border-t border-border/40 gradient-quest">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <p className="text-center text-sm text-muted-foreground mb-8">
            Built on the Solana ecosystem
          </p>

    ...
    modules: [
      ...
      },
      {
        ...
        lessons: [
          ...
          { id: 'lesson-2-2', title: 'Creating a Wallet', description: 'Generate your first Solana keypair', type: 'challenge', order: 1, content: '', xpReward: 50, duration: '15 min', challenge: { id: 'ch-1', title: 'Generate a Keypair', description: 'Create a Solana keypair using @solana/web3.js', prompt: 'Write a function that generates a new Solana keypair and returns the public key as a string.', starterCode: 'import { Keypair } from "@solana/web3.js";\n\nexport function generateKeypair(): string {\n  // Your code here\n}', solution: 'import { Keypair } from "@solana/web3.js";\n\nexport function generateKeypair(): string {\n  const keypair = Keypair.generate();\n  return keypair.publicKey.toBase58();\n}', language: 'typescript', testCases: [{ id: 'tc-1', name: 'Returns a valid base58 string', input: '', expectedOutput: 'base58_string', isHidden: false }], hints: ['Use Keypair.generate() to create a new keypair', 'The public key can be converted with .toBase58()'], difficulty: 'easy', xpReward: 50 } },
          { id: 'lesson-2-3', title: 'Sending SOL', description: 'Transfer SOL between accounts', type: 'challenge', order: 2, content: '', xpReward: 75, duration: '25 min', challenge: { id: 'ch-2', title: 'Send a SOL Transfer', description: 'Create and send a SOL transfer transaction', prompt: 'Write a function that sends SOL from one account to another on devnet.', starterCode: 'import { Connection, PublicKey, SystemProgram, Transaction } from "@solana/web3.js";\n\nexport async function sendSOL(from: string, to: string, amount: number) {\n  // Your code here\n}', solution: '', language: 'typescript', testCases: [{ id: 'tc-2', name: 'Transaction is created', input: '', expectedOutput: 'transaction_signature', isHidden: false }], hints: ['Use SystemProgram.transfer to create the instruction', 'Connect to devnet using Connection'], difficulty: 'medium', xpReward: 75 } },
        ],
      },
      {
        id: 'mod-3',
        ...
        lessons: [
          ...
          { id: 'lesson-3-3', title: 'Create Your Token', description: 'Mint your first token', type: 'challenge', order: 2, content: '', xpReward: 100, duration: '30 min', challenge: { id: 'ch-3', title: 'Boss Battle: Create a Token', description: 'Create and mint an SPL token on devnet', prompt: 'Write a function that creates a new SPL token mint on devnet.', starterCode: '// Boss Battle: Create Your First Token\n\nexport async function createToken() {\n  // Your code here\n}', solution: '', language: 'typescript', testCases: [{ id: 'tc-3', name: 'Token mint is created', input: '', expectedOutput: 'mint_address', isHidden: false }], hints: ['Use @solana/spl-token library', 'You need to create a mint account first'], difficulty: 'boss', xpReward: 100 } },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        lessons: [
          ...
          { id: 'lesson-r1-3', title: 'Error Handling', description: 'Result and Option types', type: 'challenge', order: 2, content: '', xpReward: 75, duration: '25 min' },
        ],
      },
      {
        id: 'mod-r2',
        ...
        lessons: [
          ...
          { id: 'lesson-r2-3', title: 'Boss: Build a Counter', description: 'Build a counter program from scratch', type: 'challenge', order: 2, content: '', xpReward: 100, duration: '45 min' },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        lessons: [
          ...
          { id: 'lesson-a1-3', title: 'Your First Anchor Program', description: 'Build hello world', type: 'challenge', order: 2, content: '', xpReward: 75, duration: '30 min' },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        lessons: [
          ...
          { id: 'lesson-d1-3', title: 'Build a Simple Swap', description: 'Create a token swap program', type: 'challenge', order: 2, content: '', xpReward: 100, duration: '45 min' },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        lessons: [
          ...
          { id: 'lesson-n1-3', title: 'Mint Your First cNFT', description: 'Create a compressed NFT', type: 'challenge', order: 2, content: '', xpReward: 75, duration: '30 min' },
        ],
      },
    ],
  },
    ...
    modules: [
      {
        ...
        lessons: [
          ...
          { id: 'lesson-s1-3', title: 'Find the Bug', description: 'Audit a vulnerable program', type: 'challenge', order: 2, content: '', xpReward: 100, duration: '45 min' },
        ],
      },
    ],
  },
